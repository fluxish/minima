...
{
    function doctype($type = 'xhtml11')
    {
        global $doctypes;
        
        if(!is_array($doctypes)){
            if(!require_once(APPLICATION.DS.'config'.DS.'doctypes.php')) return false;
        }
...
{
    function head_link($rel, $type = "", $href = "", $attributes = array())
    {
        if(is_array($rel)){
            $attributes = $rel;
        }
...
{
    function ul($items, $attributes = array())
    {
...
{
    function ol($items, $attributes = array())
    {
...
{
    function form_open($action, $attributes = array(), $multipart = false)
    {
...
{
    function form_input($type, $name, $value = "", $label = "", $attributes = array())
    {
...
{
    function form_text($name, $value, $label, $attributes = array())
    {
...
{
    function form_password($name, $value, $label, $attributes = array())
    {
...
{
    function form_textarea($name, $value = '', $label = '', $attributes = array())
    {
...
{
    function form_checkbox($name, $value, $label, $checked = false, $attributes = array())
    {
        if($checked){
...
{
    function form_radio($name, $value, $label, $checked = false, $attributes = array())
    {
        if($checked){
            $attributes['checked'] = 'checked';
        } else{
...
{
    function form_file($name, $value, $label, $attributes = array())
    {
...
{
    function form_submit($name, $value, $attributes = array())
    {
...
{
    function form_reset($name, $value, $attributes = array())
    {
 ...
 * @return string
 */
if(!function_exists('form_input_button'))
{
    function form_input_button($type, $name, $value = '', $attributes = array())
    {
...
{
    function form_image($name, $value, $src = "", $attributes = array())
    {
        if(!empty($src)){
            $attributes['src'] = $src;
        }
...
{
    function form_button($type, $name, $content = '', $attributes = array())
    {
...
{
    function form_select($name, $options = array(), $selected = array(), $label = '', $attributes = array())
    {
        $attributes['name'] = $name;
...
{
    function tag_open($tag, $attributes = array(), $close = false)
    {
        // add attributes
        $attrs = array();
        if(!empty($attributes)){    
...
/* Location: ./system/helpers/html.helper.php */
